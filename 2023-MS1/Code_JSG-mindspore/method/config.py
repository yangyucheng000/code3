...
class BaseOptions(object):
    ...
    modelcfg_filename = "modelcfg.json"
    ...
    def initialize(self):
        ...
        self.parser.add_argument("--num_workers", type=int, default=1, # ori: 8
        ...
        self.parser.add_argument("--model_name", type=str, default='JSGNet')
    ...
    def parse(self):
        ...
        if isinstance(self, TestOptions):
            ...
            opt.modelcfg_filepath = os.path.join(opt.model_dir, self.modelcfg_filename)
            ...
            opt.modelcfg_filepath = os.path.join(opt.results_dir, self.modelcfg_filename)
