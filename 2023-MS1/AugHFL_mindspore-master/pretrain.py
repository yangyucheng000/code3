...
test_corruption_type = cfg["test_corruption_type"]
test_corruption_rate = cfg["test_corruption_rate"]
if test_corruption_rate == 0:
    test_dataset = 'clean'
else:
...
if corruption_rate == 0:
    ...
    DATASET_DIR = './src/dataset/CIFAR-10-C_train'
dataset_classes = [
    "plane",
    "car",
    "bird",
...
if __name__ == "__main__":
    ...
    for index in range(n_participants):
        ...
        output = evaluate_network(net=network, dataloader=test_dl, loss_function="CE")
